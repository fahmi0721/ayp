...
<section class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ url('desa/users') }}">Users</a></li>
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
            <form action="javascript:void(0)" id='FormData'>
                ...
                <input type="hidden" id="id_desa" name="id_desa" value="{{ auth()->user()->id_desa }}">
                ...
                <div class="form-group">
                    ...
                    <a class='btn btn-sm btn-danger' href="{{ url('desa/users') }}" data-toggle='tooltip' title='Kembali'><i class="fa fa-reply"></i> Kembali</a>
                </div>
