    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Detail Data Kecamatan</h3>

          <div class="card-tools">
            <!-- <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
              <i class="fas fa-minus"></i>
            </button> -->
            <a href="{{ url('kabupaten/kecamatan/tambah') }}" class="btn btn-sm btn-primary">
...
<script>
    $(function() {
       $('#TableData').DataTable({
            ...
            responsive: true,
            serverSide: true,
            ajax: "{{ url('api/kecamatan/kabupaten') }}/{{ base64_encode(auth()->user()->id_kabupaten) }}",
            columns: [
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type	: "POST",
                    dataType: "json",
                    url		: "{{ url('api/kecamatan/delete') }}/"+id,
