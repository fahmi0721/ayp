      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
            <form action="javascript:void(0)" id='FormData'>
                ...
                <div class="form-group">
                    <label for="nama" autocomplete=off class='control-label'>Partai <span class='text-danger'>*</span></label>
...
<script>
    ...
    function getData(id_data){
        $.ajax({
            type : "GET",
            dataType: "json",
            url : "{{ url('api/kandidat/get_data') }}/"+id_data,
            data : "input=[]",
            error: function(er){
                console.log(er)
            },
            success: function(data){
                ...
                $("#id_partai").val(data.data.id_partai).trigger("change");
