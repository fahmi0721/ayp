...
<section class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ url('admin/partai') }}">Partai</a></li>
    ...
    <div class='col-sm-6'>
      <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Edit Data Partai</h3>
        ...
        <div class="card-body">
            <form action="javascript:void(0)" id='FormData'>
                ...
                <div class="form-group">
                    <label for="nama" autocomplete=off class='control-label'>Nama Partai <span class='text-danger'>*</span></label>
                    <input type="text" placeholder="Entri Nama Partai" name='nama' id='nama' class='form-control FormIsi'>
                </div>
                ...
                <div class="form-group">
                    ...
                    <a class='btn btn-sm btn-danger' href="{{ url('admin/partai') }}" data-toggle='tooltip' title='Kembali'><i class="fa fa-reply"></i> Kembali</a>
                </div>
...
<script>
    ...
    function getData(id_data){
        $.ajax({
            type : "GET",
            dataType: "json",
            url : "{{ url('api/partai/get_data') }}/"+id_data,
            data : "input=[]",
            error: function(er){
                console.log(er)
            },
