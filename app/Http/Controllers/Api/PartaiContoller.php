...
class PartaiContoller extends Controller
{
    private $table = "m_partai";
    private $pk_table = "";
    public function index(){
        ...
        ->addColumn('action', function($row){
                $btn = '<div class="btn-group"><a href="'.url("admin/partai/edit").'/'.base64_encode($row->id).'" class="btn btn-primary btn-xs"><i class="fa fa-xs fa-edit"></i></a>';
